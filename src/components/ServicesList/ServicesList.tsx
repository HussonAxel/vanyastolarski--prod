  ...
  return (
    <section className="m-auto w-10/12 lg:w-8/12 2xl:w-6/12">
      ...
      {Services.map((service, index) => (
        <div
          key={index}
          className={`border-b p-8 text-green transition-colors duration-300 ${
            visibleIndex === index
              ? "bg-green text-white"
            ...
            {service.images && service.images.length > 0 && (
              ...
              >
                <img
                  ...
                  className="w-full h-full object-contain max-w-[519px] max-h-[350px] cursor-pointer transition-transform duration-300 hover:scale-105"
                  onClick={() =>
                    setSelectedImage({
