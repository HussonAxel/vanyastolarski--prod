...
const BookInfos = ({
  ...
  const Section = ({ title, content }: { title: string; content: string }) => (
    <div className="mb-8">
      <h2 className="font-WorkSans text-3xl md:text-4xl lg:text-5xl text-lightgreen pb-4 md:pb-6 lg:pb-8 underline">
        {title}
      </h2>
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Header Section */}
      <div className="text-lightgreen font-WorkSans text-center mb-12 md:mb-16 lg:mb-32">
      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-16">
        ...
        <div className="w-full lg:w-auto flex justify-center">
          <img
            src={picture}
            alt="Book cover"
            className="rounded-md w-auto max-w-full lg:max-w-lg h-auto max-h-[500px] lg:max-h-[700px] shadow-2xl"
          />
        </div>
